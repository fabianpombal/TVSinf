...
CREATE PROCEDURE crear_espectaculo (IN nombre_esp varchar(30),IN fecha_in datetime,IN tipo_esp_in varchar(10),IN descripcion_esp varchar(100),
...
INSERT INTO Espectaculo VALUES(nombre_esp,descripcion_esp,tipo_esp_in,fecha_in,duracion_esp,propietario_esp);
INSERT INTO se_celebra_en VALUES(nombre_rec,localizacion_rec,nombre_esp,fecha_in);
...
LOOP
    ...
    LOOP
        ...
        INSERT Precios (precio,tipo_espectador,nombre_espectaculo,fecha,nombre_grada) VALUES (precio_espectador_aux,tipo_esp_aux,nombre_esp,fecha_in,nombre_grada_aux);
